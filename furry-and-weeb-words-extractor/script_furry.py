...
class FurryTermAnalyzer:
    def __init__(self):
        ...
        self.seed_terms = {
            'furry', 'fursuitfriday', 'fursuit', 'uwu', 'owo', 'paws', 'yiff',
            'fursona'
        }
    ...
    def compute_term_specificity(self, df):
        ...
        non_furry_freqs = np.array(non_furry_matrix.sum(axis=0)).flatten() / len(non_furry_corpus)
...
if __name__ == "__main__":
    ...
    results.to_csv('furry_terms_analysis.csv', index=False)
